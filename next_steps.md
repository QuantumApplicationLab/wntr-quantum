...
git branch -M main
git remote add origin git@github.com:QuantumApplicationLab/wntr-quantum
```
...
and create a new repository named `wntr-quantum` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/QuantumApplicationLab/wntr-quantum/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
