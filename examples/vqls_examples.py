...
inputs = ["Net0.inp", "Net1Loops.inp", "Net2Loops.inp", "Net3Loops.inp"]
...
for file in inputs:
    ...
    # set quantum linear solver
    vqls_solver = VQLS_SOLVER(
        estimator=estimator,
        ansatz=qc,
    ...
    # solve model using EPANET quantum and VQLS
    sim_quantum = wntr_quantum.sim.QuantumEpanetSimulator(wn, linear_solver=vqls_solver)
    results_quantum = sim_quantum.run_sim(linear_solver=vqls_solver)
